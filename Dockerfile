...
ENV QODER_KEEPALIVE_MS=10000
ENV QODER_TIMEOUT_MAX_ATTEMPTS=3
ENV QODER_TIMEOUT_BASE_DELAY_MS=3000
ENV QODER_TIMEOUT_MAX_DELAY_MS=15000
ENV QODER_AUTO_CONTINUE_MAX=1
