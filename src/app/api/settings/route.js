...
function toSafeSettings(settings) {
  ...
  safeSettings.modelIdleAlert = maskModelIdleAlertSettings(settings.modelIdleAlert);
...
export async function PATCH(request) {
  try {
    ...
    if (Object.prototype.hasOwnProperty.call(body, "modelIdleAlert")) {
      const current = await getSettings();
      const nextAlert = body.modelIdleAlert && typeof body.modelIdleAlert === "object"
        ? { ...body.modelIdleAlert }
        : {};
      if (!String(nextAlert.dingtalkSecret || "").trim() && current.modelIdleAlert?.dingtalkSecret) {
