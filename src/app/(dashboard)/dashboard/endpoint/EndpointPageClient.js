 ...
 // Cloudflare Tunnel state
  ...
  return (
    <div className="flex flex-col gap-8">
            ...
            {keys.map((key) => (
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  />
                  <button
                    onClick={() => setEditingRestrictionsKey(key)}
      ...
      <ApiKeyRestrictionsModal
        key={editingRestrictionsKey?.id || "closed"}
        apiKeyItem={editingRestrictionsKey}
        isOpen={!!editingRestrictionsKey}
        onClose={() => setEditingRestrictionsKey(null)}
        onSaved={async () => {
          setEditingRestrictionsKey(null);
          await fetchData();
        }}
      />
