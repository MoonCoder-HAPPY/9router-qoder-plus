...
async function runHeavyStartup() {
  ...
  import("@/shared/services/modelIdleAlert")
    .then(({ configureModelIdleAlert }) => configureModelIdleAlert(settings))
    .catch((e) => console.log("[ModelIdleAlert] scheduler start failed:", e.message));
}
