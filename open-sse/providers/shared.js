...
// Antigravity OAuth client credentials. Configure in deployment env for public forks.
export const ANTIGRAVITY_OAUTH_CLIENT = {
  clientId: process.env.ANTIGRAVITY_GOOGLE_CLIENT_ID || "",
  clientSecret: process.env.ANTIGRAVITY_GOOGLE_CLIENT_SECRET || ""
};

// Gemini (Google) OAuth client credentials. Configure in deployment env for public forks.
